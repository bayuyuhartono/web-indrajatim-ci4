			...
			<div class="row">        
				<div class="col-12 col-md-12 col-lg-12">          
					<div class="card">            
						...
						<div class="card-body">              
							<form method="post" action="<?= base_url('admin/penulis/actiontambah');?>" enctype="multipart/form-data">                
								<div class="row">                  
									  
                  <div class="col-md-6">                    
										<div class="form-group">                      
											<label>Nama Depan</label>                      
											<input type="text" name="nama_depan" class="form-control slug" required>                    
										</div>                                      
									</div>                   
                  <div class="col-md-6">
                    <div class="form-group">                      
